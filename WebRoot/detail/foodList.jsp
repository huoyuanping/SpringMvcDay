...
<!-- 主内容区域（数据列表或表单显示） -->
<div id="MainArea">
    <table class="MainArea_Content" border=1>
        <!-- 表头-->
        <thead>
        ...
        <c:forEach var="tmp" items="${requestScope.foodList.data}">
			<tr align="center">
				...
				<td>
					<a href="${pageContext.request.contextPath}/detail/updateFood.jsp
					...
					<a href="${pageContext.request.contextPath}/food?foodId=${pageScope.tmp.foodid}" class="FunctionButton">删除</a>				
				</td>
			</tr>
      </c:forEach>
